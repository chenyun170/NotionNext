...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://congruous-db.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||'70b3ba48f1114491a5ecd6f49d10e591',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '外贸获客情报局｜海关数据·进口商查询·开发信实战', // 网站标题
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION ||
    '外贸获客情报局专注海关数据与外贸获客：进口商查询、供应商关系分析、开发信模板、LinkedIn领英获客实战，用真实贸易记录帮你找到可开发的海外客户。', // 网站描述
  ...
  ALLOW_GLOBAL_JS: process.env.NEXT_PUBLIC_ALLOW_GLOBAL_JS || false, // 是否允许执行 Notion 配置中的 GLOBAL_JS
  ...
  // Fukasawa 主题：是否在侧栏显示海关数据统计入口
  FUKASAWA_SHOW_STATS_LINK:
    process.env.NEXT_PUBLIC_FUKASAWA_SHOW_STATS_LINK || false,

  // 欢迎语打字效果,Hexo,Matery主题支持, 英文逗号隔开多个欢迎语。
  GREETING_WORDS:
    process.env.NEXT_PUBLIC_GREETING_WORDS ||
    'Hi，这里是外贸获客情报局, 专注海关数据与进口商查询, 帮你找到真正在采购的海外客户, 欢迎交流图灵搜 / 顶易云 / 开发信实战',
