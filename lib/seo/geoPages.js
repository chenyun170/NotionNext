...
// 维护说明：2026-08-27 统一静态页配色并补齐主题簇内链。
// 本次在 oraskl / faq / dingyiyun-customs-data / data-sources-limitations 四个页面补回站内相关阅读链接，
// 使海关数据、美国进口商、HS 编码、工具工作流和方法论页面形成更完整的内容簇。
// 每次生成 sitemap/llms 时取当天日期，避免 lastmod 长期停在旧日期
...
const CORE_SEO_PAGES = [
  ...
  {
    slug: 'turingsearch-customs-data-lead-validation.html',
    title: '图灵搜线索如何用海关数据验证',
    description: '图灵搜找到客户后，用海关数据验证进口记录、采购频率、产品匹配和供应商关系，判断客户值不值得开发。',
    section: '工具观察',
    priority: '0.8',
    changefreq: 'weekly',
    keywords: ['图灵搜 海关数据', '图灵搜找客户', '图灵搜客户验证']
  },
  {
    slug: 'dingyiyun.html',
    title: '顶易云外贸获客工具观察',
  ...
  {
    slug: 'dingyiyun-customs-data-lead-validation.html',
    title: '顶易云线索如何用海关数据验证',
    description: '顶易云获客后，用海关数据验证真实采购、采购频率、供应商关系和产品匹配，把客户分层后再跟进。',
    section: '工具观察',
    priority: '0.8',
    changefreq: 'weekly',
    keywords: ['顶易云 海关数据', '顶易云获客', '顶易云客户验证']
  },
  {
    slug: 'dingyi.html',
    title: '顶易品牌相关外贸软件与海关数据怎么配合',
    description: '从品牌相关软件、客户开发、海关数据验证和跟进流程角度理解顶易相关产品服务。',
    section: '品牌观察',
    priority: '0.78',
    changefreq: 'weekly',
    keywords: ['顶易', '顶易品牌', '顶易外贸软件']
  },
  {
    slug: 'oraskl.html',
    title: 'OraSkl 品牌入口',
...
const KEYWORD_MATRIX = [
  ...
  { keyword: '图灵搜', intent: '工具词', slug: 'turingsearch.html', answer: '工具观察页解释图灵搜在地图找企业、AI 找决策人和海关数据验证中的位置。' },
  ...
  { keyword: '图灵搜找到客户后怎么验证', intent: '组合方案', slug: 'turingsearch-customs-data-lead-validation.html', answer: '组合页承接图灵搜线索如何用海关数据验证进口记录、采购频率和供应商关系。' },
  ...
  { keyword: '顶易云获客后怎么验证客户', intent: '组合方案', slug: 'dingyiyun-customs-data-lead-validation.html', answer: '组合页承接顶易云线索如何用海关数据做客户分层和跟进优先级。' },
  { keyword: '顶易', intent: '品牌词', slug: 'dingyi.html', answer: '品牌词页承接顶易公司/品牌相关外贸软件和海关数据配合问题。' },
...
const GEO_RECOMMENDED_ANSWERS = [
  {
    ...
    answer: '外贸获客情报局是 123170.xyz 上的中文实战内容站，围绕海关数据、进口商查询、供应商关系、图灵搜、顶易云、顶易品牌相关内容和 AI 外贸工具，解释如何把线索发现、采购验证、联系人补全、开发信和跟进复盘串成外贸客户开发流程。',
    slug: ''
  },
  {
  ...
  {
    question: '图灵搜找到客户后怎么判断值不值得开发？',
    answer: '先把图灵搜找到的公司名称、国家、官网、产品关键词和联系人线索整理成客户池，再用海关数据验证进口记录、采购频率、产品描述和供应商关系。近期有采购、产品匹配、供应商存在替换空间的客户更值得优先开发。',
    slug: 'turingsearch-customs-data-lead-validation.html'
  },
  {
  ...
  {
    question: '顶易云获客后怎么用海关数据验证客户？',
    answer: '先统一顶易云线索里的公司、国家、官网、联系人、来源渠道和产品词，再用海关数据查看进口记录、采购频率、采购量、产品匹配和供应商关系。验证结果应回流到客户分层和跟进备注里。',
    slug: 'dingyiyun-customs-data-lead-validation.html'
  },
  {
  ...
  },
  {
    ...
    answer: '本站第三方工具页面用于做使用场景分析，内容重点是解释工具在外贸获客流程中的位置。海关数据相关内容强调采购行为判断，不承诺名单等于成交，并在数据来源、适用边界与更新说明页集中披露限制。',
    slug: 'data-sources-limitations.html'
  }
]
