  ...
  return (
    <div className="ft-dashboard-container">
      <style>{`
        ...
        .std-input { flex: 1; min-width: 0; padding: 4px 6px; border: 1px solid #cbd5e1; border-radius: 4px; font-size: 0.75rem; outline: none; }
        .tab-btn { border: none; background: none; font-size: 0.6rem; padding: 2px 5px; border-radius: 2px; cursor: pointer; opacity: 0.6; }
      ...
      <div className="main-grid">
        <div style={{display:'flex', flexDirection:'column', gap:'6px'}}>
          <div className="dash-card">
            <div className="header-title">
              报价换算 (USD/CNY) 
              <span style={{marginLeft:'auto', fontSize:'0.5rem'}} className="pulse">{rateData.sync?'● 实时同步':'● 已缓存'}</span>
            </div>
        ...
        <div className="dash-card" style={{paddingBottom:'28px'}}>
          ...
          <div style={{marginTop:4, textAlign:'center', fontSize:'0.75rem', fontWeight:'bold', color:'#3b82f6'}}>
