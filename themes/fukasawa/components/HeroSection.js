  ...
  return (
    <section className='w-full pt-4 pb-8 px-4'>
      ...
      <div className='max-w-2xl mx-auto relative group'>
        <div className='relative bg-white dark:bg-stone-900 rounded-[8px] border border-stone-200 dark:border-stone-800 p-2'>
          {/* 搜索类型切换标签 */}
          <div className='flex gap-1 mb-2 px-3 border-b border-stone-100 dark:border-stone-800 pb-2'>
            {[
              { id: 'site', label: '站内教程' },
              { id: 'hs', label: 'HS编码' },
          ...
          <div className='flex items-center'>
            ...
            <button
              ...
              className='shrink-0 bg-[#d97706] hover:bg-[#b45309] text-white px-6 py-2 rounded-[8px] text-xs font-bold transition-colors'
            >
              GO
            </button>
          </div>
